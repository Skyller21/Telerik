    ...
    public class Minesweeper
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    DrawField(mines);
                    Console.Write("\nSorry! You lost! Zero points! " +
                        "Input your nickname: ", movesCounter);
        ...
        private static void MakeNextMove(char[,] field,
            char[,] minesField, int currentRow, int currentCol)
        {
